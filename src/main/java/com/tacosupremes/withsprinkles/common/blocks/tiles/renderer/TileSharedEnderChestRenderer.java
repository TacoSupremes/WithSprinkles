package com.tacosupremes.withsprinkles.common.blocks.tiles.renderer;
...
public class TileSharedEnderChestRenderer extends TileEntitySpecialRenderer<TileSharedEnderChest>
{
	...
	@Override
	public void renderTileEntityAt(TileSharedEnderChest te, double x, double y, double z, float partialTicks, int destroyStage)
	{
	        int i = 0;
